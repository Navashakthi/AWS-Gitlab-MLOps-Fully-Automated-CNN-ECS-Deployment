...
epochs = 10
num_classes = 6
s3_bucket = 'sagemaker-cicd-gitlab'
s3_train_data_key = 'tomato-classification/dataset/training_set.zip'
s3_validation_data_key = 'tomato-classification/dataset/test_set.zip'
s3_model_key = 'tomato-classification/output/tomato_leaf_classification_model.h5'
...
# Save the Model
model_path = '/opt/ml/model/tomato_leaf_classification_model.h5'
